! function(i, e) {
  ...
  var s = "0.7.9",
    ...
    y = {
      extend: function(i, e) {
        for (var s in e) "browser cpu device engine os".indexOf(s) !== -1 && e[s].length % 2 === 0 && (i[s] = e[s].concat(i[s]));
        return i
      },
      has: function(i, e) {
        return "string" == typeof i && e.toLowerCase().indexOf(i.toLowerCase()) !== -1
      },
      lowerize: function(i) {
        ...
        for (var i, s, o, r, w, l, d, p = 0, c = arguments; p < c.length && !l;) {
          ...
          for (s = o = 0; s < u.length && !l;)
            if (l = u[s++].exec(this.getUA()))
              for (r = 0; r < m.length; r++) d = l[++o], w = m[r], typeof w === t && w.length > 0 ? 2 == w.length ? typeof w[1] == n ? i[w[0]] = w[1].call(this, d) : i[w[0]] = w[1] : 3 == w.length ? typeof w[1] !== n || w[1].exec && w[1].test ? i[w[0]] = d ? d.replace(w[1], w[2]) : e : i[w[0]] = d ? w[1].call(this, d, w[2]) : e : 4 == w.length && (i[w[0]] = d ? w[3].call(this, d.replace(w[1], w[2])) : e) : i[w] = d ? d : e;
          p += 2
        }
        return i
      },
