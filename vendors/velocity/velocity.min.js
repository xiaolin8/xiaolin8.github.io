! function(e) {
  ...
  if (!e.jQuery) {
    ...
    r.isWindow = function(e) {
      ...
      if (a) {
        if (s)
          for (; i > n && (o = r.apply(e[n], a), o !== !1); n++);
        else
          for (n in e)
            if (o = r.apply(e[n], a), o === !1) break
      } else if (s)
        for (; i > n && (o = r.call(e[n], n, e[n]), o !== !1); n++);
      else
        for (n in e)
...
function(e) {
  ...
  return function(e, t, r, a) {
    ...
    function p(e, t) {
      ...
      for (var r = b.State.calls[e][0], o = b.State.calls[e][1], n = b.State.calls[e][2], s = b.State.calls[e][4], l = !1, u = 0, c = r.length; c > u; u++) {
        var p = r[u].element;
    ...
    var x = function() {
      ...
      return function a(e, t, o) {
        var n, i, s, l = {
          ...
          p = 1e-4,
          f = .016;
        for (e = parseFloat(e) || 500, t = parseFloat(t) || 20, o = o || null, l.tension = e, l.friction = t, n = null !== o, n ? (c = a(e, t), i = c / o * f) : i = f; s = r(s || l, i), u.push(1 + s.x), c += 16, Math.abs(s.x) > p && Math.abs(s.v) > p;);
        return n ? function(e) {
              ...
              switch (e) {
                ...
                case "inject":
                  ...
                  switch (t.substr(0, t.length - 1)) {
                    ...
                    case "scal":
                    case "scale":
                      b.State.isAndroid && i(r).transformCache[t] === a && 1 > o && (o = 1), n = !/(\d)$/i.test(o);
                      break;
                    case "skew":
                      n = !/(deg|\d)$/i.test(o);
                      break;
